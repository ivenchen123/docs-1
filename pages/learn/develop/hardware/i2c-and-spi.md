...
uart_mode=rs232
```
Similarly, rs485 can be selected in the environment file. The device should be rebooted after setting the uart operating mode the for the changes to take effect.
